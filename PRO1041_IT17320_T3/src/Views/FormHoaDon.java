...
public class FormHoaDon extends javax.swing.JFrame {
     ...
     */
    private Hoa_DonService service = new HoaDonServiceImpl();
    ...
    private void btn_suaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_suaActionPerformed
        ...
        this.service.update(hd, hd.getId());
        this.getData();
    ...
    private void tbl_hoaDonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_hoaDonMouseClicked
        // TODO add your handling code here:
        int row = tbl_hoaDon.getSelectedRow();
        lbl_id.setText(tbl_hoaDon.getValueAt(row, 0).toString());
        txt_ma.setText(tbl_hoaDon.getValueAt(row, 1).toString());
        txt_ngaytt.setText(tbl_hoaDon.getValueAt(row, 2).toString());

        if (tbl_hoaDon.getValueAt(row, 3).equals("Đã thanh toán")) {
            rdo_datt.setSelected(true);
        } else {
            rdo_chuatt.setSelected(true);
        }
        txt_tenNguoiNhan.setText(tbl_hoaDon.getValueAt(row, 4).toString());
        txt_diaChi.setText(tbl_hoaDon.getValueAt(row, 5).toString());
        txt_sdt.setText(tbl_hoaDon.getValueAt(row, 6).toString());
